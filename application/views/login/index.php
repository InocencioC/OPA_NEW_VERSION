...
<strong><i class="far fa-exclamation-triangle"></i>&nbsp;<?php echo $message; ?></strong> 
...
<?php endif; ?>
                <div class="p-5 ">
                  ...
                  <form class="user" name="form_index" method="POST" action="<?php echo base_url('login/auth') ?>" >
                    ...
                    <div class="form-group">
                      <input type="password" name="password" class="form-control form-control-user"  placeholder="Entre com a sua senha">
                    </div>
